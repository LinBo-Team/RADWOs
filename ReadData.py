...
def main():
    ...
    parser.add_argument('--in-path', type=str, default='./runs/Mar13_16-24-34_DESKTOP-HRPP07F', help='Tensorboard event files or a single tensorboard '
                                                                   'file location')
    parser.add_argument('--ex-path', type=str, default='./runs/Mar13_16-24-34_DESKTOP-HRPP07F/data.csv', help='location to save the exported data')
